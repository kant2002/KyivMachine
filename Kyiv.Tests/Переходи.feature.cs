...
namespace Kyiv.Tests
{
    ...
    public partial class ПорівнянняFeature : object, Xunit.IClassFixture<ПорівнянняFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("uk"), "", "Порівняння", null, global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
