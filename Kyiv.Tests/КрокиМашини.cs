...
public class КрокиМашини(IUnitTestRuntimeProvider unitTestRuntimeProvider)
{
    ...
    public void ПрипустимоРегістрЦиклуМістить(int ячейка)
    {
        машина.РегістрЦ = (ushort)ячейка;
    }

    [Given("регістр модифікації адрес містить {int}")]
    public void ПрипустимоРегістрМодифікаціїАдресиМістить(int ячейка)
    {
        машина.РегістрА = (ushort)ячейка;
    }
